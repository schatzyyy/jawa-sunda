...
├── _Example: ${prefix}quotemaker Jawa/Sunda/random_
┠≽ *${prefix}nulis text*
├── _Example: ${prefix}nulis Gw Sunda_
┠≽ *${prefix}croman TEXT dan Friend*
├── _Example: ${prefix}croman Sunda & Jawa_
┠≽ *${prefix}slide TEXT*
├── _Example: ${prefix}slide Sunda & Jawa_
┠≽ *${prefix}trigger*
...
┠≽ *${prefix}ephoto 1 - 216*
├── _Example: ${prefix}ephoto 5 Sunda_
┠≽ *${prefix}listtextpro*
├── _Example: untuk menampilkan list text pro_
┠≽ *${prefix}textpro 1 - 162*
├── _Example: ${prefix}textpro 1 Sunda_
┠≽ *${prefix}fbgoldbutton TEXT*
├── _Example: ${prefix}fbgoldbutton Sunda_
┠≽ *${prefix}tahta TEXT*
├── _Example: ${prefix}tahta Sunda_
┠≽ *${prefix}cglitch TEXT/TEXT*
├── _Example: ${prefix}cglitch Sunda/Jawa_
┠≽ *${prefix}cglass TEXT*
├── _Example: ${prefix}cglass Sunda_
┠≽ *${prefix}cballon TEXT*
├── _Example: ${prefix}cballon Sunda_
┠≽ *${prefix}cstyle TEXT*
├── _Example: ${prefix}cstyle Sunda_
┠≽ *${prefix}clove TEXT*
├── _Example: ${prefix}clove Sunda_
┠≽ *${prefix}cparty TEXT*
├── _Example: ${prefix}cparty Sunda_
┠≽ *${prefix}csky TEXT*
├── _Example: ${prefix}csky Sunda_
┠≽ *${prefix}tts id TEXT*
├── _Example: ${prefix}tts id Sunda_
┠≽ *${prefix}ttp TEXT*
├── _Example: ${prefix}ttp Sunda_
├───────────────────
┠≽ *${prefix}stiker*
